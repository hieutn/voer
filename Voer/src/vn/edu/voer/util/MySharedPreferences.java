...
public class MySharedPreferences {
	public final static String HAKARU_CROSS_PREFERENCES = "HAKARU_CROSS_PREFERENCES";
	private final String IS_AGREE_TERM = "IS_AGREE_TERM";
	...
	// ======================== UTILITY FUNCTIONS ========================
	public void putIsAgreeTerm() {
		putBooleanValue(IS_AGREE_TERM, true);
	}

	public boolean isAgreeTerm() {
		return getBooleanValue(IS_AGREE_TERM);
	}
